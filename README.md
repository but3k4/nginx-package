...
yum localinstall ../nginx-1.9.5-1.el7.x86_64.rpm \
    ../nginx-filesystem-1.9.5-1.el7.noarch.rpm
...
dpkg -i ../nginx-common_1.9.5-1_all.deb ../nginx-extras_1.9.5-1_amd64.deb
